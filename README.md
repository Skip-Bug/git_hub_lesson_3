...
Для обновления кода, вам достаточно сделать fork репозитория, сделать ряд изменений, запушить изменения в fork, а потом создать Pull Request с описанием проделанных изменений.
...
Далее создайте базу данных командой ```python manage.py migrate```. Необходимо повторять команду, при скачивании обновлений кода, в которых база данных будет меняться.
